...
public class ViewBookingServiceTest {
    ...
    public void testViewBooking_p() {
        ...
        Room room1 = new Room("1", new RoomType("1", "Badminton", 40));
        Booking booking1 = new Booking(room1, "001", "20240520", 10, 12, 100, "N", "1");
        Room room2 = new Room("2", new RoomType("1", "Badminton", 40));
        Booking booking2 = new Booking(room2, "002", "20240521", 10, 12, 100, "N", "2");
